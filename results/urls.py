...
urlpatterns = [
    ...
    path("teacher/add-marks/", add_marks_redirect, name="add_marks_redirect"),   # redirect to selection page
    path("teacher/add-marks/<int:student_id>/<int:sem_number>/", views.add_marks, name="add_marks"),
